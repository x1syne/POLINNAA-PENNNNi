...
const additionalDogServices = [
  createDogBreedService({
    id: "poodle",
    label: "Пудель",
    image: "/media/breeds/poodle.avif",
  ...
  createDogBreedService({
    id: "maltipoo",
    label: "Мальтипу",
    image: "/media/breeds/maltipoo.avif",
  ...
  createDogBreedService({
    ...
    image: "/media/breeds/german-shepherd.avif",
  ...
  createDogBreedService({
    id: "labrador",
    label: "Лабрадор",
    image: "/media/breeds/labrador.avif",
  ...
  createDogBreedService({
    id: "bulldog",
    label: "Бульдог",
    image: "/media/breeds/bulldog.avif",
  ...
  createDogBreedService({
    id: "sharpei",
    label: "Шарпей",
    image: "/media/breeds/sharpei.avif",
  ...
  createDogBreedService({
    id: "chihuahua",
    label: "Чихуахуа",
    image: "/media/breeds/chihuahua.avif",
  ...
  createDogBreedService({
    id: "maltese",
    label: "Мальтезе",
    image: "/media/breeds/maltese.avif",
  ...
  createDogBreedService({
    id: "griffon",
    label: "Гриффон",
    image: "/media/breeds/griffon.avif",
  ...
  createDogBreedService({
    id: "shih-tzu",
    label: "Ши-тцу",
    image: "/media/breeds/shih-tzu.avif",
  ...
  createDogBreedService({
    id: "bichon",
    label: "Бишон фризе",
    image: "/media/breeds/bichon.avif",
  ...
  createDogBreedService({
    ...
    image: "/media/breeds/cavalier.avif",
    imageAlt: "Спаниель после груминга",
  ...
  createDogBreedService({
    ...
    image: "/media/breeds/westie.avif",
    imageAlt: "Терьер после ухода",
  ...
  createDogBreedService({
    ...
    image: "/media/breeds/cocker-spaniel.avif",
  ...
  createDogBreedService({
    id: "schnauzer",
    label: "Цвергшнауцер",
    image: "/media/breeds/schnauzer.avif",
  ...
  createDogBreedService({
    id: "pekingese",
    label: "Пекинес",
    image: "/media/breeds/pekingese.avif",
  ...
  createDogBreedService({
    ...
    image: "/media/breeds/jack-russell.avif",
  ...
  createDogBreedService({
    ...
    image: "/media/breeds/chinese-crested.avif",
  ...
  createDogBreedService({
    id: "dachshund",
    label: "Такса",
    image: "/media/breeds/dachshund.avif",
  ...
  createDogBreedService({
    ...
    image: "/media/breeds/golden-retriever.avif",
  ...
  createDogBreedService({
    ...
    image: "/media/breeds/bernese-mountain-dog.avif",
  ...
  createDogBreedService({
    id: "samoyed",
    label: "Самоед",
    image: "/media/breeds/samoyed.avif",
  ...
  createDogBreedService({
    id: "chow-chow",
    label: "Чау-чау",
    image: "/media/breeds/chow-chow.avif",
...
const additionalCatServices = [
  createCatBreedService({
    id: "maine-coon",
    label: "Мейн-кун",
    image: "/media/breeds/maine-coon.avif",
  ...
  createCatBreedService({
    ...
    image: "/media/breeds/british-cat.avif",
  ...
  createCatBreedService({
    ...
    image: "/media/breeds/persian-cat.avif",
  ...
  createCatBreedService({
    id: "scottish-fold",
    label: "Шотландская вислоухая",
    image: "/media/breeds/scottish-fold.avif",
    imageAlt: "Шотландская вислоухая кошка после ухода",
    note: "Для шотландских кошек делаем мягкий вычес, гигиену ушей и спокойную работу с плотной плюшевой шерстью.",
  }),
  createCatBreedService({
    id: "sphynx-cat",
    label: "Сфинкс",
    image: "/media/breeds/sphynx-cat.avif",
    imageAlt: "Сфинкс после гигиенического ухода",
    note: "Сфинксам важна деликатная гигиена кожи, когтей, ушей и складок без пересушивания.",
  }),
  createCatBreedService({
    id: "bengal-cat",
    label: "Бенгальская кошка",
    image: "/media/breeds/bengal-cat.avif",
    imageAlt: "Бенгальская кошка после ухода",
    note: "Бенгалам подходит быстрый, спокойный уход: когти, уши, мягкое мытье и работа без лишней фиксации.",
  }),
  createCatBreedService({
    id: "ragdoll-cat",
    label: "Рэгдолл",
    image: "/media/breeds/ragdoll-cat.avif",
    imageAlt: "Рэгдолл после вычеса",
    note: "Рэгдоллам нужен регулярный разбор шерсти, профилактика колтунов и аккуратная сушка по длине.",
  }),
  createCatBreedService({
    id: "siberian-cat",
    label: "Сибирская кошка",
    image: "/media/breeds/siberian-cat.avif",
    imageAlt: "Сибирская кошка после ухода",
    note: "Сибирским кошкам важен тщательный вычес подшерстка и спокойная работа с густой сезонной линькой.",
  }),
  createCatBreedService({
    id: "russian-blue-cat",
    label: "Русская голубая",
    image: "/media/breeds/russian-blue-cat.avif",
    imageAlt: "Русская голубая кошка после ухода",
    note: "Русской голубой достаточно деликатного вычеса, гигиены когтей и ухода, который сохраняет плотную мягкую шерсть.",
  }),
  createCatBreedService({
    id: "abyssinian-cat",
    label: "Абиссинская кошка",
    image: "/media/breeds/abyssinian-cat.avif",
    imageAlt: "Абиссинская кошка после ухода",
    note: "Абиссинским кошкам подбираем короткую спокойную процедуру: когти, уши, мягкое мытье и быструю сушку.",
  }),
];
    ...
    videos: [
      {
        ...
        title: "Процесс ухода",
        text: "Короткое видео из салона: спокойный темп работы и аккуратный уход за питомцем.",
      },
      {
        src: "/video/channel/salon-video-01.mp4",
        poster: "/media/stories/story-01.avif",
        title: "Работа в салоне",
        text: "Фрагмент процедуры: реальная атмосфера, без потока и лишней суеты.",
      },
      {
        src: "/video/channel/salon-video-02.mp4",
        poster: "/media/stories/story-03.avif",
        title: "Гигиена и вычес",
        text: "Короткий ролик для тех, кто хочет увидеть процесс до записи.",
      },
      {
        src: "/video/channel/salon-video-03.mp4",
        poster: "/media/stories/story-05.avif",
        title: "Питомец на процедуре",
        text: "Видео с реального визита: спокойный контакт и бережная работа.",
      },
      {
        src: "/video/channel/salon-video-04.mp4",
        poster: "/media/stories/story-08.avif",
        title: "Салонный уход",
        text: "Еще один фрагмент из салона для раздела медиа.",
      },
    ],
  },
  quickActions: [
